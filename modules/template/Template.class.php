...
class Template
{
     ...
     *            true para fazer substituição fiel das tabulações
     */
     ...
     *            uma variável de template existente
     * @param string $filename
     ...
     */
    protected final function subst($varname)
    {
...
elseif (method_exists($pointer, "__get")) {
     ...
     *
     * @param string $block
     *            nome do bloco que deve ser mostrado
     * @param boolean $append
     *            true se o conteúdo anterior deve ser mantido (ou seja, para duplicar o bloco)
     */
